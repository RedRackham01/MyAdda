...
const mongoURL = "mongodb+srv://Sayanchatt:Scdbs2500@sayancluster.gmyvty1.mongodb.net/myAdda?retryWrites=true&w=majority&appName=SayanCluster";

/* MONGOOSE SETUP */
mongoose
  .connect(mongoURL)
  .then(() => {
    console.log("Mongo Connection Open".bgMagenta.white);
  })
...
seedDB().then(() => {
  ...
  console.log("Mongo Connection Closed".bgMagenta.white);
});
